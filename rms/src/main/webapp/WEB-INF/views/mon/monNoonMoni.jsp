...
<script>
			...
			success : function(result) {
				...
				if(result.length == 0){
			    	...
			    	if(cnt_gb == "ind") {
						...
						html += "<td>" + result[0].zitem6_p + "%</td>";
						html += "<td>" + result[0].zitem7_p + "%</td>";
						html += "<td></td>";
						//html += "<td></td>";
						html += "</tr>";
						...
						for (var i = 1; i < result.length; i++) {
							...
							html += "<td class='sum-item6' zrms_ym='" + result[i].zrms_ym + "'>" + result[i].zitem6_p + "%</td>";
							html += "<td class='sum-item7' zrms_ym='" + result[i].zrms_ym + "'>" + result[i].zitem7_p + "%</td>";
	...
	function excelDownloadForMon() {
		...
		openExcelPopupForSum(zregion, zdept, zdept_brch, zemp, before_yyyymm, after_yyyymm, active_bcg_id, 'excelMonMoni_d.do', '월별_모니터링.xlsx', ' ', cnt_gb);
	}
